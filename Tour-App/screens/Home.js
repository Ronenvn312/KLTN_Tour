            ...
            <View style={{ flex: 4, marginLeft: '7%', marginTop: '-2%' }}>
                <ScrollView nestedScrollEnabled >
                    ...
                    <ScrollView
                        ...
                        <View style={styles.cate_view}>
                            <TouchableOpacity style={styles.tou_cate} onPress={() => navigation.navigate('Search_Filter', { cate: "Thiên nhiên", name: txtName })}>
                                <Image source={require('../assets/sinhthai.png')} style={{ height: 35, width: 30, alignSelf: 'center' }} />
                            </TouchableOpacity>
                            <Text>Thiên nhiên</Text>
                        </View>
                        <View style={styles.cate_view}>
                            <TouchableOpacity style={styles.tou_cate} onPress={() => navigation.navigate('Search_Filter', { cate: "Thể thao", name: txtName })}>
                        ...
                        <View style={styles.cate_view}>
                            <TouchableOpacity style={styles.tou_cate} onPress={() => navigation.navigate('Search_Filter', { cate: "Nghỉ dưỡng", name: txtName })}>
                                <Image source={require('../assets/nghiduong.png')} style={{ height: 40, width: 40, alignSelf: 'center' }} />
                            </TouchableOpacity>
                            <Text>Nghỉ dưỡng</Text>
                        </View>
                        <View style={styles.cate_view}>
                            <TouchableOpacity style={styles.tou_cate} onPress={() => navigation.navigate('Search_Filter', { cate: "Biển", name: txtName })}>
