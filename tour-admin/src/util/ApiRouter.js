...
// CRUD Tour
export const addTourRoute = `${host}/api/auth/users`
export const updateTuorRoute = `${host}/api/auth/verify-email`
export const deleteTourRoute = `${host}/api/auth/resendEmail`
